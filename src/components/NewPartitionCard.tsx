...
interface NewPartitionCardProps {
	onClick: () => void;
}

export function NewPartitionCard({ onClick }: NewPartitionCardProps) {
	return (
		<button
			type="button"
		...
		>
			...
			<span className="text-base-content/50 text-sm font-medium">New partition</span>
		</button>
	);
}
